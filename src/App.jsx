...
import { ArrowRight, ArrowUpRight, Plus, Minus, Instagram, Linkedin, Twitter } from 'lucide-react';
...
const CASES = [
  { client: 'Fintech Startup', tags: ['ABM', 'GTM'], result: 'Zero to Series A pipeline in 6 months.', metric: '₹18Cr', metricLabel: 'pipeline generated' },
  { client: 'D2C Skincare', tags: ['PAID', 'CGI'], result: 'CAC dropped 41%. ROAS up 3.2×.', metric: '3.2×', metricLabel: 'ROAS lift' },
  { client: 'SaaS Scale-Up', tags: ['SEO'], result: 'Organic traffic up 280%. AI answer citations up ∞.', metric: '280%', metricLabel: 'traffic growth' },
  { client: 'Hospitality Group', tags: ['WEB'], result: 'Site speed 0.9s. Bookings up 68%.', metric: '0.9s', metricLabel: 'LCP' },
  { client: 'B2B Manufacturing', tags: ['ABM'], result: '17 of 50 target accounts, booked.', metric: '34%', metricLabel: 'target hit rate' },
  { client: 'Consumer Electronics', tags: ['CGI'], result: '0 photoshoots. 240 assets shipped.', metric: '240', metricLabel: 'assets produced' },
];

const TEAM = [
  { name: 'Arjun Mehra', role: 'Strategy Lead', split: ['Ar', 'jun'] },
  { name: 'Priya Shetty', role: 'Creative Director', split: ['Pri', 'ya'] },
  { name: 'Rohan Iyer', role: 'Growth Lead', split: ['Ro', 'han'] },
  { name: 'Sana Kapoor', role: 'Head of Operations', split: ['Sa', 'na'] },
];
...
const Logo = ({ color = C.white, size = 28 }) => (
  <svg width={size * 1.12} height={size} viewBox="0 0 45 40" fill="none" aria-label="Mile 1">
    <rect x="2" y="22" width="9" height="14" fill={color} rx="1" />
    <rect x="14" y="12" width="9" height="24" fill={color} rx="1" />
    <path d="M28 4 L42 4 L42 18" stroke={color} strokeWidth="3.5" fill="none" strokeLinecap="square" strokeLinejoin="miter" />
  </svg>
);
...
const LogoWord = ({ color = C.white, size = 24 }) => (
  <div className="flex items-center gap-2.5" style={{ color }}>
    ...
    <div style={{ lineHeight: 1 }}>
      <div style={{ fontSize: size * 0.82, fontWeight: 700, letterSpacing: '-0.02em' }}>Mile 1</div>
      <div style={{ fontSize: size * 0.32, letterSpacing: '0.2em', fontWeight: 500, opacity: 0.7, marginTop: 2 }}>START RIGHT</div>
    </div>
  </div>
);
  ...
  return (
    <>
      ...
      >
        ...
        <div style={{ padding: '120px clamp(20px, 4vw, 56px) 48px', display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(0, 0.6fr)', gap: 40, height: '100%' }}>
          ...
          >
            ...
            <div>
              ...
              <a href="mailto:hello@mile1.in" style={{ color: C.white, fontSize: 18, fontWeight: 500 }}>hello@mile1.in</a>
            </div>
            <div>
              ...
              <div className="flex gap-4" style={{ color: C.white }}>
                <a style={{ opacity: 0.8 }}><Instagram size={18} /></a>
                <a style={{ opacity: 0.8 }}><Linkedin size={18} /></a>
                <a style={{ opacity: 0.8 }}><Twitter size={18} /></a>
              </div>
            </div>
...
const ProgressRail = ({ milestones, theme }) => {
  ...
  return (
    <div
      style={{
        position: 'fixed', left: 28, top: 0, bottom: 0, zIndex: 200,
        pointerEvents: 'none',
    ...
    >
      <div style={{ position: 'relative', height: '58vh' }}>
        <div style={{ position: 'absolute', left: 6, top: 0, bottom: 0, width: 1, borderLeft: `1px dashed ${color}`, opacity: 0.25 }} />
        ...
        {milestones.map((m, i) => {
          ...
          return (
            <div key={i} style={{ position: 'absolute', left: 0, top, transform: 'translateY(-50%)', display: 'flex', alignItems: 'center', gap: 14 }}>
              <MilestoneDot active={isActive} size={12} color={isActive ? C.blue : color} />
              <span style={{ fontSize: 10, color, opacity: i === active ? 1 : 0.5, letterSpacing: '0.2em', fontWeight: 700, whiteSpace: 'nowrap' }}>{m}</span>
            </div>
          );
        })}
      </div>
...
const Marquee = ({ items, bg = C.charcoal, fg = C.white, speed = 32 }) => (
  <div style={{ background: bg, color: fg, borderTop: `1px solid ${fg}15`, borderBottom: `1px solid ${fg}15`, overflow: 'hidden', padding: '22px 0' }}>
    <div
      style={{
  ...
  <footer style={{ background: C.charcoal, color: C.white, padding: '0 clamp(20px, 4vw, 56px) 40px' }}>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 40, padding: '56px 0 40px' }}>
      <div>
        ...
        <a href="mailto:hello@mile1.in" style={{ color: C.white, fontSize: 17 }}>hello@mile1.in</a>
      ...
      <div>
        ...
        <div className="flex gap-3">
          {[Instagram, Linkedin, Twitter].map((Icon, i) => (
            <div key={i} style={{ padding: 10, border: `1px solid ${C.gray}33`, borderRadius: 999, cursor: 'pointer' }} data-cursor="OPEN">
...
const HomePage = ({ setPage }) => {
  const marqueeItems = ['ABM', 'GTM STRATEGY', 'PAID ADS', 'WEB DEV', 'SEO · GEO · AIEO', 'CGI STUDIO', 'START RIGHT'];
          ...
          <div>
            ...
            <Reveal delay={120}>
              <h2 style={{ fontSize: 'clamp(40px, 5vw, 72px)', fontWeight: 700, letterSpacing: '-0.03em', lineHeight: 1.05, marginTop: 20, maxWidth: 780 }}>
                Six services. <br /><span style={{ color: C.gray }}>One finish line.</span>
              </h2>
            </Reveal>
          </div>
          <Reveal delay={220}>
        ...
        >
          <div style={{ display: 'flex', gap: 20, paddingBottom: 30, width: 'max-content' }}>
            {SERVICES.map((s, i) => (
              ...
              >
                <div>
                  <div style={{ fontSize: 11, color: i % 2 === 0 ? C.blue : C.white, fontWeight: 700, letterSpacing: '0.2em', marginBottom: 24 }}>MILE 3.{s.num}</div>
                ...
                <div style={{ position: 'relative', height: 340, overflow: 'hidden', background: C.sand, marginBottom: 16 }}>
                  <div
                    ...
                    style={{
                      ...
                      background: `linear-gradient(135deg, ${i === 0 ? '#1a1a2e' : i === 1 ? '#c77b5c' : '#2a3f5f'} 0%, ${i === 0 ? C.blue : i === 1 ? '#e8c4a0' : '#4d7aa8'} 100%)`,
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                    }}
                  >
                    <div style={{ fontSize: 64, fontWeight: 700, color: `${C.white}22`, letterSpacing: '-0.04em' }}>0{i + 1}</div>
                  </div>
      ...
      <section style={{ padding: '140px clamp(20px, 4vw, 56px)', background: C.sand, color: C.charcoal }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 48, borderTop: `1px dashed ${C.charcoal}33`, paddingTop: 60 }}>
          {[
            ...
            { num: 14, suffix: '', label: 'countries shipped to' },
      ...
      <section style={{ padding: '160px clamp(20px, 4vw, 56px)', background: C.blue, color: C.white, position: 'relative', overflow: 'hidden' }}>
        ...
        <Reveal delay={340}>
          <div style={{ marginTop: 48, display: 'flex', alignItems: 'center', gap: 20, flexWrap: 'wrap' }}>
            ...
            <div style={{ fontSize: 11, color: C.white, letterSpacing: '0.2em', fontWeight: 700, opacity: 0.85 }}>MILE 0 → MILE 1</div>
          </div>
        </Reveal>
      </section>
  ...
  return (
    <main style={{ background: C.sand, color: C.charcoal }}>
      ...
      <section style={{ minHeight: '92vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '120px clamp(20px, 4vw, 56px) 80px', position: 'relative' }}>
        <Reveal><Eyebrow num="02 / MILE TWO" color={`${C.charcoal}99`}>THE ORIGIN</Eyebrow></Reveal>
        <Reveal delay={160}>
          ...
          {[
            ...
            <Reveal key={i} delay={i * 140}>
              <div style={{ borderTop: `1px dashed ${C.gray}66`, paddingTop: 28, paddingRight: 16, paddingBottom: 40, position: 'relative' }}>
                ...
                <div style={{ fontSize: 11, color: C.blue, fontWeight: 700, letterSpacing: '0.2em', marginBottom: 16 }}>MILE 3.{p.num}</div>
      ...
      {/* TEAM */}
      <section style={{ padding: '140px clamp(20px, 4vw, 56px)', background: C.sand }}>
        <Reveal><Eyebrow num="04" color={`${C.charcoal}88`}>THE PACE-SETTERS</Eyebrow></Reveal>
        <Reveal delay={120}>
          <h2 style={{ fontSize: 'clamp(42px, 6vw, 88px)', fontWeight: 700, letterSpacing: '-0.03em', lineHeight: 1, marginTop: 24, marginBottom: 72 }}>
            Meet the team.
          </h2>
        </Reveal>
            ...
            <Reveal key={t.name} delay={i * 100}>
              ...
              >
                <div
                  style={{
                    aspectRatio: '4/5',
                    background: hoverTeam === i ? C.blue : `linear-gradient(145deg, ${C.charcoal}, #1a1a20)`,
                ...
                >
                  <div
                    style={{
                      ...
                      transform: hoverTeam === i ? 'translateY(-10px) scale(1.06)' : 'translateY(0) scale(1)',
                      transition: 'transform 600ms cubic-bezier(0.7,0,0.2,1)',
                    }}
                  >
                    {t.name.split(' ').map((w) => w[0]).join('')}
                  </div>
                  <div style={{ position: 'absolute', bottom: 16, left: 16, right: 16, display: 'flex', justifyContent: 'space-between', color: C.white, fontSize: 10, letterSpacing: '0.2em', fontWeight: 700, opacity: 0.85 }}>
                    <span>0{i + 1}</span>
                    <span style={{ opacity: hoverTeam === i ? 1 : 0.4, transition: 'opacity 300ms' }}>SAY HI →</span>
                  </div>
                </div>
                <div>
                  <div style={{ fontSize: 'clamp(24px, 2vw, 30px)', fontWeight: 700, letterSpacing: '-0.015em', lineHeight: 1.1, overflow: 'hidden' }}>
                    ...
                    <span style={{ opacity: 0.35, fontWeight: 500, marginLeft: 8 }}>{t.name.split(' ')[1]}</span>
                  </div>
                  <div style={{ fontSize: 12, letterSpacing: '0.15em', color: `${C.charcoal}88`, marginTop: 6, fontWeight: 700 }}>
                    {t.role.toUpperCase()}
                  </div>
                </div>
              </div>
  ...
  return (
    <main style={{ background: C.charcoal, color: C.white }}>
      ...
      <section style={{ minHeight: '90vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '120px clamp(20px, 4vw, 56px) 80px', position: 'relative', overflow: 'hidden' }}>
        <Reveal><Eyebrow num="03 / MILE THREE">THE TOOLKIT</Eyebrow></Reveal>
        <Reveal delay={180}>
          <h1 style={{ fontSize: 'clamp(56px, 10vw, 176px)', fontWeight: 700, letterSpacing: '-0.04em', lineHeight: 0.92, margin: '32px 0' }}>
            Six services. <br /><em style={{ color: C.blue, fontStyle: 'italic' }}>Zero</em> shortcuts.
          </h1>
        </Reveal>
        <Reveal delay={360}>
        ...
        return (
          ...
          >
            <div style={{ position: 'absolute', top: -7, left: 'clamp(20px, 4vw, 56px)', display: 'flex', alignItems: 'center', gap: 14 }}>
              <MilestoneDot active size={14} />
              <span style={{ fontSize: 11, letterSpacing: '0.2em', color: C.blue, fontWeight: 700 }}>MILE 3.{s.num}</span>
            </div>
            ...
            <Reveal delay={600}>
              <div style={{ marginTop: 80, display: 'flex', alignItems: 'center', gap: 14 }}>
                <span style={{ fontSize: 11, letterSpacing: '0.2em', color: dark ? C.gray : `${C.charcoal}88`, fontWeight: 700 }}>
                  MILE 3.{s.num} → MILE {i === SERVICES.length - 1 ? '4' : `3.${String(Number(s.num) + 1).padStart(2, '0')}`}
                </span>
      ...
      <section style={{ padding: '160px clamp(20px, 4vw, 56px)', background: C.blue, color: C.white, position: 'relative', overflow: 'hidden' }}>
        ...
        <Reveal delay={140}>
          <h2 style={{ fontSize: 'clamp(44px, 7vw, 112px)', fontWeight: 700, letterSpacing: '-0.035em', lineHeight: 0.98, marginTop: 28, marginBottom: 40, maxWidth: 1100 }}>
            You&apos;ve reached Mile 3.6. <br /><span style={{ opacity: 0.7 }}>Now what?</span>
          </h2>
        </Reveal>
        <Reveal delay={280}>
...
const PortfolioPage = ({ setPage }) => {
  ...
  const filters = ['ALL', 'ABM', 'GTM', 'PAID', 'WEB', 'SEO', 'CGI'];
  const filtered = filter === 'ALL' ? CASES : CASES.filter((c) => c.tags.includes(filter));

  const gradients = [
    'linear-gradient(135deg, #1a1a2e 0%, #3355FF 100%)',
    'linear-gradient(135deg, #c77b5c 0%, #e8c4a0 100%)',
    'linear-gradient(135deg, #2a3f5f 0%, #4d7aa8 100%)',
    'linear-gradient(135deg, #0F0F10 0%, #333340 100%)',
    'linear-gradient(135deg, #3355FF 0%, #99aaff 100%)',
    'linear-gradient(135deg, #1a1a20 0%, #c77b5c 100%)',
  ];
  ...
  return (
    <main style={{ background: C.sand, color: C.charcoal }}>
      ...
      <section style={{ minHeight: '80vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '120px clamp(20px, 4vw, 56px) 80px' }}>
        <Reveal><Eyebrow num="04 / MILE FOUR" color={`${C.charcoal}99`}>THE TRACK RECORD</Eyebrow></Reveal>
        <Reveal delay={180}>
              ...
              <Reveal key={c.client} delay={i * 80}>
                ...
                >
                  <div style={{ position: 'relative', aspectRatio: big ? '16/8' : '4/5', overflow: 'hidden', marginBottom: 18 }}>
                    ...
                    />
                    <div className="pnum" style={{ position: 'absolute', left: 24, bottom: 24, fontSize: 96, fontWeight: 700, color: `${C.white}22`, letterSpacing: '-0.04em', lineHeight: 0.8, transition: 'transform 500ms cubic-bezier(0.7,0,0.2,1)' }}>
                      0{i + 1}
                    </div>
  ...
  return (
    <main style={{ background: C.charcoal, color: C.white }}>
      ...
      <section style={{ position: 'relative', padding: '140px clamp(20px, 4vw, 56px) 80px', overflow: 'hidden' }}>
        ...
        <Reveal><Eyebrow num="05 / MILE FIVE">THE START GUN</Eyebrow></Reveal>
        <Reveal delay={180}>
          ...
          <div style={{ maxWidth: 820, margin: '60px auto', textAlign: 'center', padding: 40 }}>
            <Reveal>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
                ...
                <span style={{ fontSize: 11, color: C.blue, letterSpacing: '0.2em', fontWeight: 700 }}>MESSAGE SENT · MILE 5.1</span>
              </div>
            </Reveal>
            <Reveal delay={160}>
...
export default function App() {
  ...
  const theme = page === 'about' || page === 'portfolio' ? 'light' : 'dark';

  // Railway milestones per page
  const railMilestones = {
    home: ['START', 'THESIS', 'TOOLKIT', 'WORK', 'STATS', 'VOICE', 'GO'],
        ...
        <>
          ...
          >
            <div style={{ color: C.white, fontSize: 14, letterSpacing: '0.3em', fontWeight: 700 }}>
              MOVING TO MILE {NAV.find((n) => n.id === page)?.num}
            </div>
          </div>
