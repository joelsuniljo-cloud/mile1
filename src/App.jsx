...
const NAV = [
  ...
  { id: 'work', label: 'What We Make', num: '03' },
...
const FORMATS = [
  {
    ...
    name: 'AI UGC Ads',
    short: 'UGC',
    tagline: 'Looks like a customer. Converts like one.',
    desc: "The highest-converting ad format on Meta and TikTok right now — a real-feeling person, talking about your product, without hiring a single creator or waiting three weeks for a shoot.",
  },
  {
    num: '02',
    slug: 'product-photo',
    ...
    short: 'PHOTO',
    tagline: 'One photo in. A full catalog out.',
    desc: "Studio shots, lifestyle scenes, on-model imagery — generated from a single product photo, ready for every platform, every size, every campaign.",
  },
  {
    num: '03',
    slug: 'cinematic',
    name: 'Cinematic Product Films',
    short: 'FILM',
    tagline: 'Photoshoots without the flights, catering, or weather.',
    desc: "Hyper-real CGI product films that look better than the real thing and cost a fraction — built once, reused forever, across every channel you run.",
  },
  {
    num: '04',
    slug: 'story',
    name: 'Story-Style Ads',
    short: 'STORY',
    tagline: 'A scenario. A hook. A sale.',
    desc: "Full AI-directed scenarios — characters, settings, a reason to stop scrolling — built around your product as the hero of someone else's story.",
  },
  {
    num: '05',
    slug: 'multilingual',
    name: 'Multi-Language Ads',
    short: 'LANG',
    tagline: 'One ad. Every market that matters.',
    desc: "The same winning ad, dubbed and localized in minutes — not re-shot, re-briefed, or re-priced for every region you sell in.",
  },
  {
    num: '06',
    slug: 'variants',
    name: 'High-Volume Ad Variants',
    short: 'TEST',
    tagline: 'Ad fatigue is a budget problem. We just solved it.',
    desc: "Dozens of hooks, angles, and cuts of your best-performing ad — tested and refreshed before your CPA has time to climb.",
  },
];
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 40, padding: '56px 0 40px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
          {NAV.map((n) => (
            <a
              ...
              style={{ color: C.white, fontSize: 14, cursor: 'pointer', opacity: 0.85 }}
              data-cursor="GO"
            >
              {n.label}
            </a>
      ...
      <div>
        ...
        <div style={{ color: C.gray, fontSize: 13, lineHeight: 1.6 }}>
          We're the AI production house that makes ads people actually buy from.
        </div>
      </div>
    </div>
...
const HomePage = ({ setPage }) => {
  const offerings = [
    'UGC Videos',
    'Branded Face / Avatar Videos',
    'AI Product Photos',
    'Multi-language Ads',
    'Offer / Promo Videos',
    'Before / After Videos',
    'Story-style / Cinematic Ads',
  ];
  ...
  return (
    <main style={{ background: C.charcoal, color: C.white }}>
      ...
      <section style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '120px clamp(20px, 4vw, 56px) 80px', position: 'relative', overflow: 'hidden' }}>
        ...
        <Reveal delay={100}>
          <Eyebrow num="01 / MILE ONE">AI PRODUCTION HOUSE</Eyebrow>
        </Reveal>
        ...
        <Reveal delay={360}>
          <p style={{ color: C.gray, fontSize: 'clamp(18px, 2vw, 22px)', maxWidth: 560, lineHeight: 1.5 }}>
            We're an AI production house that turns a product photo and a rough brief into an ad that converts — no shoot, no six-week timeline, no guessing. Just creative built to sell, and the numbers to prove it did.
          </p>
        </Reveal>
        ...
        <Reveal delay={520}>
          <div style={{ margin: '48px 0 40px', display: 'flex', alignItems: 'center', gap: 16, maxWidth: 720 }}>
            ...
            <span style={{ fontSize: 11, color: C.blue, fontWeight: 700, letterSpacing: '0.2em' }}>MILE 01 — FIRST AD, LIVE THIS WEEK</span>
          </div>
        </Reveal>
        ...
        <Reveal delay={640}>
          <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap', alignItems: 'center' }}>
            <MagneticButton primary onClick={() => setPage('contact')}>
              Get a High-Converting Ad <ArrowRight size={16} />
            </MagneticButton>
      ...
      <Marquee items={offerings} type="text" speed={40} />
      ...
      <section style={{ padding: '160px clamp(20px, 4vw, 56px)', background: C.sand, color: C.charcoal, position: 'relative' }}>
        <Reveal>
          <Eyebrow num="02" color={`${C.charcoal}88`}>THE PROBLEM WITH MOST ADS</Eyebrow>
        </Reveal>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(380px, 1fr))', gap: 60, marginTop: 40 }}>
          <Reveal delay={120}>
            <h2 style={{ fontSize: 'clamp(42px, 5vw, 76px)', fontWeight: 700, letterSpacing: '-0.03em', lineHeight: 1.02 }}>
              Most ads are made to be admired. <br />We make ads to be <em style={{ color: C.blue, fontStyle: 'italic' }}>clicked</em>.
            </h2>
          </Reveal>
          <Reveal delay={280}>
            <div style={{ maxWidth: 500, paddingTop: 12 }}>
              <p style={{ fontSize: 18, lineHeight: 1.7, color: `${C.charcoal}cc`, marginBottom: 16 }}>
                A beautiful ad that nobody buys from is a very expensive piece of art. We start from the opposite end: what makes someone stop scrolling, believe you, and act — on a Tuesday, mid-scroll, with a thumb that&apos;s already moving to the next post.
              </p>
              <p style={{ fontSize: 18, lineHeight: 1.7, color: `${C.charcoal}cc`, marginBottom: 28 }}>
                That&apos;s the only brief that matters. Everything we build — the hook, the shot, the copy, the CTA — is reverse-engineered from that one moment. Most production houses find out if it worked after the invoice is paid. We build for it from frame one.
              </p>
              <div onClick={() => setPage('about')} data-cursor="READ" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, cursor: 'pointer', color: C.charcoal, fontWeight: 700, borderBottom: `2px dashed ${C.charcoal}`, paddingBottom: 4 }}>
                See how we build a converting ad <ArrowUpRight size={16} />
              </div>
            </div>
          </Reveal>
        </div>
      ...
      {/* SECTION 03 — formats strip */}
      <section id="formats-section" style={{ padding: '160px 0 140px', background: C.charcoal, position: 'relative' }}>
        <div style={{ padding: '0 clamp(20px, 4vw, 56px)', marginBottom: 60, display: 'flex', justifyContent: 'space-between', alignItems: 'end', flexWrap: 'wrap', gap: 24 }}>
          <div>
            <Reveal>
              <Eyebrow num="03">THE FORMATS</Eyebrow>
            </Reveal>
            <Reveal delay={120}>
              <h2 style={{ fontSize: 'clamp(40px, 5vw, 72px)', fontWeight: 700, letterSpacing: '-0.03em', lineHeight: 1.05, marginTop: 20, maxWidth: 780 }}>
                Six ways we get you a sale.
              </h2>
            </Reveal>
          </div>
          <Reveal delay={220}>
            <div onClick={() => setPage('portfolio')} data-cursor="EXPLORE" style={{ display: 'inline-flex', alignItems: 'center', gap: 10, cursor: 'pointer', color: C.blue, fontWeight: 700, fontSize: 14, letterSpacing: '0.1em' }}>
        ...
        >
          <div style={{ display: 'flex', gap: 20, paddingBottom: 30, width: 'max-content' }}>
            {FORMATS.map((s, i) => (
              ...
              >
                <div>
                  <div style={{ fontSize: 11, color: i % 2 === 0 ? C.blue : C.white, fontWeight: 700, letterSpacing: '0.2em', marginBottom: 24 }}>FORMAT · {s.num}</div>
          ...
          <Reveal delay={120}>
            <div>
              <h2 style={{ fontSize: 'clamp(40px, 5vw, 76px)', fontWeight: 700, letterSpacing: '-0.03em', lineHeight: 1.02, marginBottom: 28 }}>
                The work still needs real <em style={{ color: C.blue, fontStyle: 'italic' }}>craft.</em>
              </h2>
              <p style={{ fontSize: 'clamp(17px, 1.6vw, 20px)', color: `${C.gray}`, lineHeight: 1.6, maxWidth: 520, marginBottom: 18 }}>
                AI gets us speed. For the films that need to feel flawless in every frame — the kind that ran for Sony, Duroflex, and Jio Cinemas — we build alongside <strong style={{ color: C.white }}>WeSualize Studios</strong>, one of India&apos;s sharpest 3D and CGI teams. Same promise either way: an ad that earns the click, not just the compliment.
              </p>
      ...
      <section style={{ padding: '140px clamp(20px, 4vw, 56px)', background: C.sand, color: C.charcoal }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 48, borderTop: `1px dashed ${C.charcoal}33`, paddingTop: 60 }}>
          {[
            { num: 340, suffix: '%', label: 'avg. lift in ad conversion rate' },
            { num: 48, suffix: 'hrs', label: 'from brief to first ad, live' },
            { num: 100, suffix: '%', label: 'shot-free — every single one' },
          ].map((s, i) => (
      ...
      <section style={{ padding: '140px clamp(20px, 4vw, 56px)', background: C.charcoal }}>
        ...
        <Reveal delay={160}>
          <blockquote style={{ fontSize: 'clamp(28px, 4vw, 56px)', fontWeight: 500, letterSpacing: '-0.02em', lineHeight: 1.2, margin: '40px 0', maxWidth: 1200, color: C.white }}>
            &ldquo;We stopped asking Mile 1 for &lsquo;creative.&rsquo; We just ask for the <em style={{ color: C.blue, fontStyle: 'italic' }}>number</em> we need to hit — and they build backwards from there.&rdquo;
          </blockquote>
        </Reveal>
        <Reveal delay={320}>
      ...
      <section style={{ padding: '160px clamp(20px, 4vw, 56px)', background: C.blue, color: C.white, position: 'relative', overflow: 'hidden' }}>
        ...
        <Reveal delay={180}>
          <h2 style={{ fontSize: 'clamp(52px, 7vw, 120px)', fontWeight: 700, letterSpacing: '-0.035em', lineHeight: 0.98, maxWidth: 1200 }}>
            Your next ad could be live by Friday.
          </h2>
        </Reveal>
        <Reveal delay={260}>
          <p style={{ color: C.white, opacity: 0.85, fontSize: 'clamp(17px, 1.8vw, 20px)', maxWidth: 640, lineHeight: 1.5, marginTop: 24 }}>
            No shoot. No six-week timeline. Just an ad built to convert — and the AI production house that builds it fast.
          </p>
        </Reveal>
        <Reveal delay={340}>
          <div style={{ marginTop: 48, display: 'flex', alignItems: 'center', gap: 20, flexWrap: 'wrap' }}>
            <div onClick={() => setPage('contact')} data-cursor="START" style={{ cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: 12, background: C.white, color: C.blue, padding: '18px 30px', borderRadius: 999, fontWeight: 700, fontSize: 15 }}>
              Get a High-Converting Ad <ArrowRight size={18} />
            </div>
  ...
  return (
    <main style={{ background: C.sand, color: C.charcoal }}>
      ...
      <section style={{ padding: '120px clamp(20px, 4vw, 56px)', background: C.charcoal, color: C.white }}>
        <Reveal><Eyebrow num="03">HOW WE WORK</Eyebrow></Reveal>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 40, marginTop: 60 }}>
          {[
            { num: '01', title: 'The Hook', desc: "We find the three seconds that stop the scroll. Everything else is built around getting that moment right first." },
            { num: '02', title: 'The Build', desc: 'No shoot, no crew, no six-week wait. AI production means we go from brief to a finished, running ad in days.' },
            { num: '03', title: 'The Proof', desc: "We watch what converts, kill what doesn't, and keep making variants of what works. The numbers decide, not our taste." },
          ].map((p, i) => (
...
export default function App() {
  ...
  const railMilestones = {
    home: ['START', 'THESIS', 'FORMATS', 'WORK', 'PARTNERS', 'STATS', 'VOICE', 'GO'],
